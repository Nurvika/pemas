	...
	<table class="table table-respons">
		...
		<tbody>
			<tr>
				...
				<td>
					<a href="index.php?halaman=detailpengaduan&id_pengaduan=<?php echo $list['id_pengaduan']; ?>" class="btn btn-sm btn-info">Detail&verifikasi</a>
					<a href="index.php?halaman=tanggapan&id_pengaduan=<?php echo $list['id_pengaduan']; ?>" class="btn btn-sm btn-info">Tanggapan</a>
				</td>
			</tr>
