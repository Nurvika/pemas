...
<html>
	<head>
		...
		<title>Silahkan masukkan keluhhan anda</title>
		...
		<section class="header">
			<nav class="navbar navbar-expand-lg bg-light navbar-light">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link disabled" href="#">Masalah</a>
					</li>
				</ul>
			</nav>
			<div class="container-fluid" id="center">
				<div class="container">
					<div class="jumbotron">
						...
						<p class="lead">
							<a href="index.php?halaman=pengaduan" class="btn btn-lg btn-success">Laporan</a>
						</p>
					</div>
				</div>
			</div>
