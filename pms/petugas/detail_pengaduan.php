<div class="card shadow">
  ...
  <div class="card-body">
  	<div class="form-group cols-sm-6">
  		<a href="petugas.php?halaman=verifikasi" class="btn btn-primary btn-icon-split">
  			<span class="text">Kembali</span>
  		</a>
  		<a href="proses.php?id=<?php echo $list['id_pengaduan'] ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('yakin adkan diproses')">
